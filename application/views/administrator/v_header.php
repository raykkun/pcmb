...
<p>
<form name="form" action="<?php echo base_url();?>index.php/administrator/header/tambah" method="post">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="center">
            <a href="<?php echo base_url();?>index.php/administrator/header/edit/<?php echo $db['id_header'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Ubah'>
			</a>
            <a href="<?php echo base_url();?>index.php/administrator/header/hapus/<?php echo $db['id_header'];?>"
