...
--
-- Host: localhost
-- Generation Time: May 02, 2014 at 11:28 AM
...
(6, '123', '123', 'tes', '2013-12-13', '32055664', 'Administrator', '2013', 200000),
(7, '234', '234', 'AAA', '2013-12-13', '80105590', 'Administrator', '2013', 200000),
(8, '123456', '0877748468', 'Deddy Rusdiansyah', '2014-04-26', '77661787', 'Administrator', '2014', 200000),
(9, '234567', '0877748468', 'Danish Putra Pramudia', '2014-04-26', '89623522', 'Administrator', '2014', 200000);
...
CREATE TABLE `msformulir` (
  ...
  PRIMARY KEY (`noformulir`,`noujian`,`kodeakses`),
  KEY `Jur1` (`kodeakses`) USING BTREE,
  KEY `KdPS` (`biaya`) USING BTREE,
  KEY `KetLulusKdPSNIM` (`biaya`) USING BTREE,
  KEY `NIMNoDaftarNama` (`noformulir`) USING BTREE,
  KEY `NoDaftar` (`noformulir`) USING BTREE,
  KEY `ThAjaran` (`thajaran`) USING BTREE,
  KEY `ThAjaranKdPSJur1NoDaftar` (`thajaran`,`biaya`,`kodeakses`,`noformulir`) USING BTREE,
  KEY `ThAjaranKdPSLulusJurNIM` (`thajaran`,`biaya`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `mspcmb` (
  ...
  KEY `Jur1` (`Jur1`) USING BTREE,
  KEY `KdPS` (`KdPS`) USING BTREE,
  KEY `KetLulus` (`KetLulus`) USING BTREE,
  KEY `KetLulusKdPSNIM` (`KetLulus`,`KdPS`,`NIM`) USING BTREE,
  KEY `LulusJur` (`LulusJur`) USING BTREE,
  KEY `LulusJur0` (`LulusJur`) USING BTREE,
  KEY `NIM` (`NIM`) USING BTREE,
  KEY `NIMNoDaftarNama` (`NIM`,`NoDaftar`,`Nama`) USING BTREE,
  KEY `NoDaftar` (`NoDaftar`) USING BTREE,
  KEY `ThAjaran` (`ThAjaran`) USING BTREE,
  KEY `ThAjaranKdPSJur1NoDaftar` (`ThAjaran`,`KdPS`,`Jur1`,`NoDaftar`) USING BTREE,
  KEY `ThAjaranKdPSLulusJurNIM` (`ThAjaran`,`KdPS`,`LulusJur`,`NIM`) USING BTREE,
  KEY `UseiID` (`UserID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `mspcmb`
--

INSERT INTO `mspcmb` (`NoDaftar`, `NoUjian`, `ThAjaran`, `Angkatan`, `KdPS`, `Jur1`, `Jur2`, `Jur3`, `TglDaftar`, `NIM`, `Nama`, `TmptLhr`, `TglLhr`, `JK`, `Alamat1`, `Alamat2`, `Telp`, `EMail`, `Kota`, `WN`, `TB`, `BB`, `GolDarah`, `Hobby`, `Penyakit`, `AsalSek`, `NmAsalSek`, `NoIjazah`, `IjTh`, `IjJmlMP`, `IjJmlNilai`, `NmAyah`, `NmIbu`, `KerjaAyah`, `KerjaIbu`, `HasilAyah`, `HasilIbu`, `PendAyah`, `PendIbu`, `NmWali`, `AlamatWali`, `HubWali`, `RUjian`, `UTulis`, `ULisan`, `LulusJur`, `KetLulus`, `tglmsk`, `status`, `tglkeluar`, `ipk`, `tglmuna`, `judulskripsi`, `UserID`, `TglUpdate`, `pwd`, `online`, `ipaddress`, `Survey`, `foto`, `file_ijazah`) VALUES
...
INSERT INTO `survey` (`survey`, `jml`) VALUES
('Teman', 496),
('Koran', 31),
('Internet', 156),
('Brosur', 237),
...
('deddy', '7d018f0c5742a1ac0b016eefade7777d', 'Administrator', 'deddy.rusdiansyah@gmail.com', '087774846856', 'admin', 'N', ''),
('tes', '28b662d883b6d76fd96e4ddc5e9ba780', 'tes', '', '', 'user', 'N', '');
